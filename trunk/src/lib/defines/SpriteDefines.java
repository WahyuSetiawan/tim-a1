...
{
	int BG_BELAKANG1	= 0;
	int BG_BELAKANG2 	= BG_BELAKANG1 + 1;
	int BG_TENGAH		= BG_BELAKANG2 + 1;
	...
	{
		new ElementSprite("gfx/gameplay/1. bg_belakang1.png"),
		new ElementSprite("gfx/gameplay/2. bg_belakang2.png"),
